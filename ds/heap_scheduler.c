...
/*compare function*/
int IsMatch(const void *data, void* arg);
...
{
    UNUSED(param);
    if(TaskGetTimeToRun((void*)data1) < TaskGetTimeToRun((void*)data2))
    {
        return (-1);
    }
    if(TaskGetTimeToRun((void*)data1) > TaskGetTimeToRun((void*)data2))
...
int IsMatch(const void *data, void* arg)
{
    return (UIDIsSame(TaskGetUID((void*)data), *(UID_t*)arg));
}